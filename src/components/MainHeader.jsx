...
export default function MainHeader({ view, date, onPrev, onNext }) {
  const title = view === 'daily' ? 'Daily' : 'Calendar'
  const dateLabel = view === 'daily' ? formatDay(date) : formatMonth(date)
